<?php
	...
	//팀
	if(isset($_POST['team']) === false){
		nowexit(false, '팀 값이 없습니다.');
	}
	if(is_numeric($_POST['team']) === false || $_POST['team'] < 0){
		nowexit(false, '유효하지 않은 팀 값입니다.');
	}
	$team_sid = $_POST['team'];
	...
	//회원 등록
	$sql = "INSERT INTO user_data(id, pw, id_num, is_admin, team_sid) VALUES ('$id', '$pw', '$id_num', '1', '$team_sid');";
	$query_result = sql($sql);
